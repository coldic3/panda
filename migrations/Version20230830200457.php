...
final class Version20230830200457 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE panda_report (id UUID NOT NULL, portfolio_id UUID NOT NULL, name VARCHAR(255) NOT NULL, started_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ended_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, entry_type VARCHAR(255) NOT NULL, entry_configuration JSON NOT NULL, file_storage VARCHAR(255) NOT NULL, file_filename VARCHAR(255) NOT NULL, PRIMARY KEY(id))');

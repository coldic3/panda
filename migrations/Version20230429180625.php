...
final class Version20230429180625 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE panda_operation (id UUID NOT NULL, asset_id UUID DEFAULT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_39D110735DA1941 ON panda_operation (asset_id)');
        $this->addSql('COMMENT ON COLUMN panda_operation.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN panda_operation.asset_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE panda_operation ADD CONSTRAINT FK_39D110735DA1941 FOREIGN KEY (asset_id) REFERENCES panda_asset (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    {
        $this->addSql('ALTER TABLE panda_operation DROP CONSTRAINT FK_39D110735DA1941');

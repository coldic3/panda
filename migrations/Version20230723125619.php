...
final class Version20230723125619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panda_exchange_rate ADD base_ticker VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE panda_exchange_rate ADD quote_ticker VARCHAR(255) NOT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1992C039D58BBB05589C0D1C ON panda_exchange_rate (base_ticker, quote_ticker)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panda_exchange_rate DROP base_ticker');
        $this->addSql('ALTER TABLE panda_exchange_rate DROP quote_ticker');
